...
class IndexController extends AbstractController
{
    ...
    public function index(Poster $poster = null, News $new = null)
    {
        ...
        $description = "CartelON. Gráfica Cubana, programa de fomento al diseño serigráfico en Cuba. 
            Genera y promueve concursos de carteles dando continuidad a la tradición del cartel cultural serigráfico en el país. 
            Gestiona además la impresión y montaje sus exposiciones asociadas.";
     ...
     */
    public function morePosterEvents($amount, $pos = null): JsonResponse
    {
        ...
        if ($pos===null) {
            ...
            if ($amountPosterEvents === null || $amountPosterEvents < 1) {
                $amountPosterEvents = $this->amountPosterEventDefault;
            }
